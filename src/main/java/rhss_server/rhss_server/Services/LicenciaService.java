...
public class LicenciaService {
    ...
    public String postLicencia (LicenciaDto data) {
        ...
        emailSender.sendEmailActionNovedad(usuario.getEmail(), novedad.getNumero(),
         novedad.getCategoria(), novedad.getFecha(), data.categoria,info,novedad.getNovedad_id(), novedad.getEmpresaId());
    ...
    public String[] getCategories() {
        String[] cat = {"ART", "LICENCIA POR ENFERMEDAD", "LICENCIA POR EMBARAZO", "LICENCIA DE VACACIONES", "ATENCION FAMILIAR", "LINCENCIA DE MATRIMONIO","LICENCIA DE FALLECIMIENTO"};
        return cat;
    }
}
